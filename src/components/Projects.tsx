...
const projects = [{
  ...
  description: 'Organization at your fingertips. Guild Board isnt just another social platform—its where ideas evolve into startups while the rest of social media keeps you consuming. Here, you dont scroll—you build.
