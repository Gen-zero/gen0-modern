...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      {/* Section Title */}
      <div className={cn(
        "container mx-auto px-6 mb-12 transition-all duration-700 transform",
        ...
        <div className="mt-4 w-24 h-1 bg-gradient-to-r from-secondary via-primary to-accent mx-auto rounded-full" />
      </div>
      
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        {/* Service Navigation */}
        <div className={cn(
          "lg:col-span-5 transition-all duration-700 transform",
          ...
          <div className="space-y-4">
            {services.map((service, index) => (
              <div 
                ...
                className={cn(
                  "p-6 rounded-xl cursor-pointer transition-all duration-300 transform group",
                  currentIndex === index 
              ...
              >
                <div className="flex items-center">
                  <div className={cn(
                    "p-3 rounded-lg mr-4 transition-all",
                    currentIndex === index 
                  ...
                  <ArrowRight className={cn(
                    ...
                    currentIndex === index 
                      ...
                      : "opacity-0 text-white/40 group-hover:opacity-70 group-hover:translate-x-1"
                  )} />
                </div>
              </div>
            ))}
        ...
        {/* Service Details */}
        <div className={cn(
          "lg:col-span-7 relative min-h-[60vh] lg:min-h-[70vh] flex items-center justify-center transition-all duration-700 transform",
          isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"
        )}>
          {services.map((service, index) => (
            <div
              key={index}
              className={cn(
                "absolute inset-0 flex flex-col items-center justify-center p-8 rounded-2xl backdrop-blur-sm transition-all duration-700",
                currentIndex === index 
            ...
            >
              ...
              <div className="text-center z-10 max-w-xl mx-auto relative transform transition-all duration-700">
                ...
                {/* CTA Button */}
                <Button 
                  className="px-8 py-6 rounded-full text-lg font-medium text-white bg-gradient-to-r from-accent/90 to-accent hover:from-accent hover:to-accent/90 hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-accent/20"
                >
                  Start Now
      ...
      {/* Service Indicators */}
      <div className={cn(
        "flex justify-center gap-2 mt-12 container mx-auto transition-all duration-700",
