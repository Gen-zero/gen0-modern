...
const AboutSection = () => {
  ...
  return (
    ...
    >
      {/* Content Block */}
      <div className="w-full mb-8 lg:mb-0 lg:inline-block lg:align-top lg:w-1/2 lg:pr-8">
      ...
      {/* Values Block */}
      <div className="w-full lg:inline-block lg:align-top lg:w-1/2">
        <div className="mb-8">
        ...
        <div className="hidden">
          ...
          <p className="w-full text-muted-foreground">
            ...
            Proven 📌 to deliver solutions 🚀 that don&apos;t just hit expectations—they smash them! 🔥
          </p>
        </div>
      </div>
    </div>
