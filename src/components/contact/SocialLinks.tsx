...
const SocialLinks = () => {
  // Discord icon component (using SVG since Discord isn't in lucide-react default set)
  const DiscordIcon = () => (
  ...
  return (
    <div className="flex space-x-4">
      ...
      <a href="https://www.linkedin.com/company/gen-zer0/?viewAsMember=true" className="p-2 rounded-full bg-primary/5 hover:bg-primary/10 transition-colors" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
        <Linkedin className="h-5 w-5" />
      </a>
      <a href="https://discord.gg/Ufg8gQWUXr" className="p-2 rounded-full bg-primary/5 hover:bg-primary/10 transition-colors" aria-label="Discord" target="_blank" rel="noopener noreferrer">
        <DiscordIcon />
      </a>
    </div>
  );
