  ...
  return (
    <>
      ...
      <div className={`fixed inset-0 z-50 flex items-center justify-center ${menuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'} transition-all duration-500`}>
        ...
        <div className="relative w-full max-w-7xl mx-auto h-full max-h-[calc(100vh-40px)] p-6 md:p-10 overflow-visible">
          {/* Close Button */}
          <button 
          ...
          <div className="flex flex-col mb-6 md:mb-8">
            <div className="flex items-center gap-4 mb-4">
              <img src="/lovable-uploads/a9bfe93b-b4a8-45e7-b6ec-0ccf561e4234.png" alt="Gen0 Logo" className="h-12 md:h-16 object-contain" />
              <div className="flex items-center gap-3">
                <Sparkles className="text-accent h-5 w-5 md:h-6 md:w-6 animate-pulse-subtle" />
                <span className="font-bold text-lg md:text-xl lg:text-2xl">GEN<span className="text-accent">Ø</span></span>
              </div>
            </div>
            
            {/* Animated Punchline - reduced size */}
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold max-w-3xl mb-2 bg-gradient-to-r from-foreground via-foreground/90 to-foreground/70 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
            ...
            <div className="md:col-span-5 lg:col-span-4">
              <div className="space-y-6">
                ...
                <Button 
                  className="w-full text-base py-6 px-8 mt-4 font-medium rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-accent/20 group" 
                  onClick={() => toggleMenu()}
                >
                  Get in Touch
            ...
            <div className="md:col-span-7 lg:col-span-8">
              ...
              <div className="mt-8 hidden md:block">
                <div className="relative">
                  <div className="h-[1px] w-full bg-border/30 relative overflow-hidden group-hover:overflow-visible">
