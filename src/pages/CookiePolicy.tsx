...
const CookiePolicy = () => {
  const title = "Cookie Policy | Gen0";
  const description = "Learn about how Gen0 uses cookies and similar technologies to enhance your browsing experience on our website.";
  const canonicalUrl = "https://gen0.xyz/cookie-policy";
  
  // Structured data for the legal page
  ...
  return (
    <>
      <SEO
        ...
        ogTitle="Cookie Policy | Gen0 Digital Studio"
        ogDescription={description}
        ogType="website"
        linkedinTitle="Cookie Policy | Gen0"
        linkedinDescription="Learn how Gen0 uses cookies to improve your browsing experience and the options you have to control them."
