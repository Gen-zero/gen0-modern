        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex flex-col gap-2 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl">
              Explore our portfolio of work across web development, design, and brand identity. Each project showcases our commitment to excellence and innovation.
            </p>
          </div>
            ...
            {projects.map((project, index) => (
              ...
              >
                <div 
                  ...
                  style={{opacity: hoveredProject === project.id ? 0.9 : 0.6}}
                ></div>
